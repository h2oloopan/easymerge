...
def main(cmdline, dir=None, custom_distance_threshold=None, custom_size_threshold=None):
    ...
    if custom_size_threshold:
        arguments.size_threshold = custom_size_threshold
