...
Over past decades, many techniques and approaches have been proposed to detect code clones. However, how to refactor clones is still a challenging topic to software
...
In this paper, we introduce EasyMerge, a new tool to refactor code clones.
\end{abstract}
