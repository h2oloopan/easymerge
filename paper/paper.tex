...
based on evaluation of external variable references and function calls. It copes with features of Python language and can deal with clone segments in functions,
classes, and across different scopes. It ensures functionality-wise consistency before and after refactoring and provide warnings when potential refactoring could lead to
...
proposed a new metric DIST (distance of the code clones). Unlike them, instead of calculating distance between code segments and only merging close clones, EasyMerge 
